/*************************************************************************
    > File Name: StrobogrammaticNumberIII.java
    > Author: lwei2
    > Mail: lwei2@IT.com 
    > The Description :
 ************************************************************************/
public class Solution
{
	...
	{
		if(n == 0)
			return new ArrayLsit<String>(Arrays.asList(""));
		if(n == 1)
			return new ArrayLsit<String>(Arrays.asList("1", "8", "0"));
	...
	public int strobogrammaticInRange(String low, String high)
	{
		int count = 0;
		List<String> result = new ArrayList<String>();
		for(int i = low.length(); i <= high.lenght(); i++)
